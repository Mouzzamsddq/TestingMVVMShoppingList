...
import com.example.testingmvvshoppinglist.other.Constants
import com.example.testingmvvshoppinglist.other.Event
...
/**
 *...Now we clearly understand that why we created interface because now our view model can take both.
 *...repository we don't need to create separate view model for testing.
 */

/**
 * ...In this project, we are following the principle Of TDD which is test driven development
 * ... For this we should write first method signature then test cases then method implementation
 */
